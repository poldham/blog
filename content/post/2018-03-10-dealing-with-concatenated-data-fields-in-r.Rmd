...
Here we will use the [drones dataset](https://poldham.github.io/drones/), a new dataset of patent data involving drone technology. As it's a big dataset we will just use the applicants field with 18,970 rows. 
