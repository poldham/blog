...
description: "If you are looking for how to import Excel into R... read this update. It's now much easier to import and the post also covers the dreaded https problem and using writexl."
...
```{r specify_types}
df <- read_excel("/Users/pauloldham17inch/blog/content/post/df.xlsx", col_names = TRUE, col_types = c("numeric", "text", "logical", "text"))
df
```
