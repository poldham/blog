---
title: Exploring Geocoding Scientific Literature with R
author: Paul Oldham
date: '2018-05-22'
slug: geocoding-scientific-literature-with-r
description: Exploring geocoding 5000 organisation names from Web of Science in R with the Google Maps API using the placement, ggmap and googleway packages. 
categories:
  - Patents
tags:
  - bibliometrics
...
```{r import_affiliation, eval=FALSE}
